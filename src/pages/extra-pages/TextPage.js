        ...
        <>
            ...
            <MainCard>
                <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Stack direction="row" spacing={2} alignItems="center" sx={{py: 2}}>
                        <LoadingButton size="small" variant="contained" sx={{textTransform: 'capitalize'}}
                                       type="submit">
                            Encrypt
                        </LoadingButton>
                    </Stack>
                ...
                <Stack direction="row" spacing={2}>
                    ...
                    <IconButton size="medium" variant="contained"
                                sx={{display: 'flex', px: 1, textTransform: 'capitalize'}} onClick={handleLinkCopy}>
                        <Box display="flex" alignItems="center">
                            <CopyOutlined/>
                        </Box>
                    </IconButton>
                ...
                <Stack direction="row" alignItems="center" spacing={2} sx={{py: 2}}>
                    <Stack>
                        <Typography sx={{mt: 3.5}}>
                            You can share the link with your choice of communication channels like Slack
                            DM,<br></br> WhatsApp, Telegram and etc. Please
                ...
                <Typography sx={{my: 3.5}}>
                    You also can share the link secured link above via email but it must be protected with the PIN. The
                    PIN must be shared secretly in
                ...
                <Typography>
                    Warning! Remember that secrets can only be downloaded once if not set otherwise. So do not open the
                    link yourself.
                </Typography>
                <Typography>The PIN should be shared separately with other communication channels. It&apos;s not
                    included in the email</Typography>
            </MainCard>
        </>
    );
};
