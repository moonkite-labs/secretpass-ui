...
// 5. Decrypt the link with the PIN - const decryptedLink = CryptoJS.AES.decrypt(encryptedLink, randomPIN.toString()).toString(CryptoJS.enc.Utf8);  // returns the original link
